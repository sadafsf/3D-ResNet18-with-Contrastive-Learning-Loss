# INCOMPELETE - CHECK THE FREEZE PART 
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        # classification without the projection 
        ...
        # classification after projection head 
        self.relu = nn.ReLU(inplace=True)
        self.fc_wprojection= nn.Linear(output_dim, num_classes)
    ...
    def forward_projection(self, x):
        x=self.forward_constrative(x)
        x=self.relu(x)
        return self.fc_wprojection(x)
